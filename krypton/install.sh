...
verify_bottle_hash() {
  ...
  test "$DOWNLOADED_HASH" = "$BOTTLE_HASH" || (
    say "Downloaded binary hash incorrect. Aborting."
    rm /tmp/$BOTTLE_FILE
    exit 1
  ) || exit 1
  say "Binary verified."
...
install_darwin_manual() {
  ...
  10.11)
    BOTTLE_FILE=kr-2.4.13.el_capitan.bottle.2.tar.gz
    BOTTLE_HASH=c7ff5433486daa1654ec79806b0fcb9aafcc7dc052e166c5c68fa707ed49e2b4
    ;;
  10.12)
    BOTTLE_FILE=kr-2.4.13.sierra.bottle.2.tar.gz
    BOTTLE_HASH=2285ce4eebb3ee75ab9678676c15bf133d5a3d24d2b7a4dc4da31179de699462
    USE_KRBTLE=1
    ;;
  10.13)
    BOTTLE_FILE=kr-2.4.13.high_sierra.bottle.2.tar.gz
    BOTTLE_HASH=b5278156184a7f50ed04790ecc7081be5c3f3d82c07da64d9683bf5db19472cb
    USE_KRBTLE=1
    ;;
  10.14)
    BOTTLE_FILE=kr-2.4.13.mojave.bottle.2.tar.gz
    BOTTLE_HASH=8901218264de65fdbf2dc258f00557e456416f9f32fb9511956d546fea0a804a
    USE_KRBTLE=1
    ;;
  10.15)
    BOTTLE_FILE=kr-2.4.13.mojave.bottle.2.tar.gz
